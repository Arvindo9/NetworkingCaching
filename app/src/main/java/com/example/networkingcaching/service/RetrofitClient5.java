...
public class RetrofitClient5 {
    ...
    public static final String BASE_URL_3 = "http://devapiik.tapow.sg/";
...
//            cache = new Cache(httpCacheDirectory, 10485760);
    ...
    private static OkHttpClient getOkhttpClient(Cache cache) {
...
//        interceptor.level(HttpLoggingInterceptor.Level.BODY);
    ...
    public static Retrofit getRetrofitInstance(Context context) {
        RetrofitClient5.context = context;
        if (retrofit == null) {
            retrofit =  new Retrofit.Builder()
                    .baseUrl(BASE_URL)
                    .addConverterFactory(GsonConverterFactory.create(getGson()))
//                    .addConverterFactory(GsonConverterFactory.create())
                    .client(getOkhttpClient(getHttpCache(context)))
                    .build();
        }
        return retrofit;
    }
    ...
    public static Retrofit getRetrofitInstance3(Context context) {
        RetrofitClient5.context = context;
        if (retrofit3 == null) {
